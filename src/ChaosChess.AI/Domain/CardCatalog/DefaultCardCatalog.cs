...
namespace ChaosChess.AI.Domain.CardCatalog
{
    public sealed class DefaultCardCatalog
    {
        private static readonly CardCatalogEntry[] DefaultEntries =
        {
            ...
            Entry("aim", "AimCard.asset", "AimCard", UnityCardType.Piece, false, CardCatalogSupportGrade.NeedsCommonPrimitive, CardCatalogActivationWave.Wave2, "movement-override-state", "Piece movement override."),
            ...
            Entry("fast_march", "FastMarchCard.asset", "FastMarchCard", UnityCardType.Piece, false, CardCatalogSupportGrade.NeedsCommonPrimitive, CardCatalogActivationWave.Wave2, "movement-override-state", "Piece movement override."),
            ...
            Entry("fire", "FireCard.asset", "FireCard", UnityCardType.Tile, true, CardCatalogSupportGrade.NeedsCommonPrimitive, CardCatalogActivationWave.Wave0, "tile-duration", "Existing Unity AI card; effect duration must be represented for exact application."),
            ...
            Entry("peace_zone", "PeaceZoneCard.asset", "PeaceZoneCard", UnityCardType.Tile, true, CardCatalogSupportGrade.NeedsCommonPrimitive, CardCatalogActivationWave.Wave0, "tile-duration", "Existing Unity AI card; effect duration must be represented for exact application."),
            Entry("portal", "PortalCard.asset", "PortalCard", UnityCardType.Tile, true, CardCatalogSupportGrade.NeedsCommonPrimitive, CardCatalogActivationWave.Wave0, "tile-duration-destination", "Existing Unity AI card; linked endpoint destination must be represented for exact application."),
